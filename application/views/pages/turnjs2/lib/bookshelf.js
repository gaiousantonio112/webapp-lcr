...
var currentDemo,
  ...
  samples = {
    'steve-jobs' : {'path' : base_url +'../application/views/pages/turnjs2/samples/steve-jobs/'}
    // 'steve-jobs' : {'path' : base_url +'../application/views/pages/samples/steve-jobs/'},
    // 'html5' : {'path' : base_url +'../application/views/pages/samples/html5/'},
    // 'docs' : {'path' : base_url +'../application/views/pages/samples/docs/'}
    // 'magazine1' : {'path' : base_url +'../application/views/pages/samples/magazine1/'},
    // 'magazine2' : {'path' : base_url +'../application/views/pages/samples/magazine2/'},
    // 'magazine3' : {'path' : base_url +'../application/views/pages/samples/magazine3/'}
