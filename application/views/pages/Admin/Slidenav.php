...
<ul class="list-group list-group-flush pt-2 ">
  <li class="text-left list-group-item list-group-item-action pl-2"  style="border:0px solid">
        <a href="<?php echo base_url() . 'pages/admin/index'  ?>" ><img src="<?php echo base_url() .'/assets/svg/dashboard(samp).svg' ?>" height="25px" alt=""><span class="nav-text">Dashboard </span></a>
  </li>
  <li class="text-left list-group-item list-group-item-action pl-2" style="border:0px solid">
        <a href="<?php echo base_url() . 'pages/admin/Users'  ?>" ><img src="<?php echo base_url() .'/assets/svg/search(samp).svg' ?>" height="25px" class="mr-3" alt=""><span class="nav-text"> User Manager</span></a>
  </li>
  <!-- <li class="text-left list-group-item list-group-item-action pl-2" style="border:0px solid">
