...
<div class="d-flex wrapper" id="wrapper"  >
    ...
    <div class="bg-ecris  border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush pt-4"  >
        <a href="<?php echo base_url() . 'pages/dash/index'  ?>" class=" font-weight-bold text-left list-group-item list-group-item-action bg-ecris bg-title" ><img src="<?php echo base_url() .'/assets/svg/dashboard(ecris).svg' ?>" height="25px" class="float-left mr-2" alt=""> Dashboard</a>
